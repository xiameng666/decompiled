...
public final class elut implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new ActivityStartEvent(f, f1, activityCandidate0, additionalActivityCandidates0);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new ActivityStartEvent[v];
    }
}
