...
final class aqor extends aqpt {
    final hisk a;

    public aqor(aqov aqov0, aqwm aqwm0, hisk hisk0) {
        this.a = hisk0;
    ...
    protected final String b() {
        Uri.Builder uri$Builder0 = aqov.a().appendPath("backups").appendQueryParameter("android_id", String.valueOf(this.a.d));
