...
import com.google.android.gms.westworld.ConfigOperation;

public class ffoh extends IntentOperation implements eixj, ejbp {
    ...
    public final void onCreate() {
        if(!this.c) {
            this.c = true;
            ((ffno)this.h()).d(((ConfigOperation)this));
        }
    }
}
