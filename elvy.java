...
public final class elvy implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new PlaceOngoingEvent(v1, f, f1, placeCandidate0, additionalPlaceCandidates0);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new PlaceOngoingEvent[v];
    }
}
