...
public final class acjq implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        String s = null;
        DocumentsParcel documentsParcel0 = null;
        ...
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v2)) {
                ...
                case 3: {
                    documentsParcel0 = (DocumentsParcel)baua.m(parcel0, v2, DocumentsParcel.CREATOR);
                    break;
                }
                case 4: {
        ...
        baua.A(parcel0, v);
        return new PutDocumentsAidlRequest(appSearchAttributionSource0, s, documentsParcel0, userHandle0, v1);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new PutDocumentsAidlRequest[v];
    }
}
