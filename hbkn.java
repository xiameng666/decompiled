public enum hbkn implements gpdm {
    NO_ERROR(0),
    ...
    REMOTE_MODEL_LOADER_ERROR(0x6F),
    REMOTE_MODEL_LOADER_LOADS_NO_MODEL(0x70),
    SMART_REPLY_LANG_ID_DETECTAION_FAILURE(0x71),
    MODEL_NOT_REGISTERED(0x72),
    MODEL_TYPE_MISUSE(0x73),
    MODEL_HASH_MISMATCH(0x74),
    ...
    OPTIONAL_MODULE_CREATE_ERROR(0xCF),
    ...
    SAPI_INTERNAL_ERROR_DOUBLE_MODEL_LOAD_ATTEMPT(0x2CF),
