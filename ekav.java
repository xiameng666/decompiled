...
public final class ekav {
    public static final int a;
    private static final bboh b;

    static {
        ekav.b = bboh.b("ROM_LoadBlacklist", bbcu.bN);
    }
    ...
    public static final Set a(Context context0) {
        ...
        try {
            ...
            try {
            label_12:
                ((ggtj)((ggtj)((ggtj)ekav.b.i()).s(iOException0)).ar(0x3481)).B("Failed to read blacklist from file %s", iOException0);
                goto label_16;
            }
            catch(Throwable throwable0) {
            }
