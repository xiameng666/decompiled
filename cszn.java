...
public final class cszn implements ldr {
    public static final cszn a;
    ...
    public final Object b(InputStream inputStream0) {
        ...
        ProtoLiteMessage hftv0 = ((ProtoLiteMessage)ctef.a).x_newMutableInstance();
        try {
    ...
    public final Object c(Object object0, OutputStream outputStream0) {
        ((ctef)object0).writeToStream(outputStream0);
        return ibom.a;
    }
}
