final class bdtf implements ibtx {
    final boolean a;
    final boolean b;
    final gra c;
    final long d;
    ...
    public bdtf(boolean z, boolean z1, gra gra0, long v, bdtt bdtt0) {
        this.a = z;
        this.b = z1;
        this.c = gra0;
        this.d = v;
    ...
    public final Object a(Object object0, Object object1, Object object2) {
        ...
        boolean z = this.a && bdto.b(this.c) != bdqn.c;
        hey hey0 = hfc.e;
        hfc hfc0 = bdtv.a(bdtv.b(hey0, this.b, 2), z);
        long v1 = this.d;
        bdtt bdtt0 = this.e;
        gra gra0 = this.c;
        ...
        if(object3 == gop.a) {
            object3 = new bdte(gra0);
            ((goz)object1).R(object3);
        }
        ((goz)object1).A();
        hfc hfc3 = cru.d(hfc2, false, null, null, null, ((ibth)object3), 15);
        String s = bdtw.a(bdtt0.b, ((goz)object1));
        boolean z1 = bdto.b(gra0) == bdqn.c;
        bdqc.c(hfc3, isq.b(0x7F13005D, bdtt0.b.size(), new Object[]{bdtt0.b.size()}, ((goz)object1)), s, 0x7F0805E8, z1, 0L, 0L, ((goz)object1), 0, 0x60);  // plurals:pwm_passkey_count
        ((goz)object1).z();
        return ibom.a;
    }
}
