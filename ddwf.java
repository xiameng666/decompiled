...
final class ddwf implements ibty {
    final Activity a;
    final nry b;

    public ddwf(nry nry0, Activity activity0) {
        this.b = nry0;
        this.a = activity0;
        super();
    }
    ...
    public final Object a(Object object0, Object object1, Object object2, Object object3) {
        ...
        if(v1 != 0 || object4 == gop.a) {
            object4 = new ddwd(nry0, activity0);
        ...
        if(z || object5 == gop.a) {
            object5 = new ddwe(nry0);
            ((goz)object2).R(object5);
        }
        ((goz)object2).A();
        dfnd.f(((ibth)object4), ((ibth)object5), ((goz)object2), 0);
        return ibom.a;
    }
}
