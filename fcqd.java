final class fcqd implements ibtw {
    final gra a;
    final String b;

    public fcqd(gra gra0, String s) {
        this.a = gra0;
        this.b = s;
        super();
    }
    ...
    public final Object a(Object object0, Object object1) {
        ...
        if(v != 0 || object3 == gop.a) {
            object3 = new fcqc(s, pgi0);
            ((goz)object0).R(object3);
        }
        ((goz)object0).A();
        pry.b(z, ((ibth)object2), ((ibts)object3), iqn.a(hfc.e, "open_on_phone_confirmation_dialog"), null, null, 0L, null, ((goz)object0), 0xC00);
        return ibom.a;
    }
}
