...
final class aafp extends ibuo implements ibts {
    public aafp(Object object0) {
        super(1, object0, aafw.class, "onToolbarNavigationStateChanged", "onToolbarNavigationStateChanged(Lcom/google/android/gms/accountsettings/mg/poc/ui/viewmodel/appbar/ToolbarNavigationState;)V", 0);
    }

    @Override  // ibts
    public final Object a(Object object0) {
        ibns ibns0;
        ibuq.f(((aase)object0), "p0");
        aafw aafw0 = (aafw)this.e;
        switch(((aase)object0).ordinal()) {
            case 0: {
        ...
        productLockupToolbar0.x(new aafl(aafw0));
        return ibom.a;
    }
}
