...
final class ebcw implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebcw(dola dola0, dmgr dmgr0, domv domv0) {
        this.h = dola0;
        this.i = domv0;
        this.j = dmgr0;
        ebcv ebcv0 = new ebcv(domv0);
        this.a = ebcv0;
        dolf dolf0 = new dolf(dola0);
        this.b = dolf0;
        dmgj dmgj0 = new dmgj(ebcv0, dolf0);
        this.c = dmgj0;
        dole dole0 = new dole(dola0);
        this.d = dole0;
        ears ears0 = new ears(ebcv0, dole0);
        this.e = ears0;
        earp earp0 = new earp(ebcv0, dole0, ears0);
        this.f = earp0;
        this.g = DoubleCheck.b(new eaqy(ebcv0, dmgj0, earp0));
    }
