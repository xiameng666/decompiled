...
public final class bnfx extends cjtm {
    private final BrowserRegisterRequestParams a;
    private final bnfn b;

    public bnfx(bnfn bnfn0, BrowserRegisterRequestParams browserRegisterRequestParams0, azug azug0) {
        super(0x76, "RegisterPrivileged", azug0);
        this.b = bnfn0;
        this.a = browserRegisterRequestParams0;
    }
