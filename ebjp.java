...
final class ebjp implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebjp(dola dola0, dmgr dmgr0, domw domw0, edor edor0, domv domv0) {
        this.r = domv0;
        this.s = domw0;
        this.t = dola0;
        this.u = dmgr0;
        ebjn ebjn0 = new ebjn(domv0);
        this.a = ebjn0;
        ebjm ebjm0 = new ebjm(domv0);
        this.b = ebjm0;
        eczr eczr0 = new eczr(ebjn0, ebjm0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(ebjn0);
        this.e = ecwf0;
        this.f = ebjq.a;
        ecwe ecwe0 = new ecwe(ebjn0, ebjq.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(ebjn0, eczr0, ecwf0, ecwe0, ebjq.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(ebjn0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(ebjn0);
        this.m = dmkm0;
        ebjo ebjo0 = new ebjo(edor0);
        this.n = ebjo0;
        edrn edrn0 = new edrn(edsf0, dmkm0, ebjo0);
        this.o = edrn0;
