...
public final class fmnt extends LinearLayout implements fmwl {
    ...
    public fmnt(Context context0) {
        ...
        typedArray0.recycle();
        fmnt.inflate(this.getContext(), 0x7F0E08BB, this);  // layout:richcard_layout
        ...
        this.c = (fmnn)this.findViewById(0x7F0B1E81);  // id:rich_card_content
    ...
    public final void a(fmwd fmwd0) {
        ...
        if(gfsx1.i()) {
            fmnn0.a(((fmlz)gfsx1.d()), this.f, this.g, this.h, this.e, fmga0);
        }
        this.a.a(fmwd0);
        this.b.a(fmwd0);
    }
    ...
    public final void c(fmnr fmnr0) {
        ...
        this.setOnClickListener(new fmns(fmnr0));
        this.setClickable(z);
    }
}
