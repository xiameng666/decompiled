...
public final class ..__AppSearch__MobileApplication implements aeu {
    @Override  // aeu
    public final aes a() {
        aef aef0 = new aef("MobileApplication");
        ...
        aei0.a = true;
        aef0.c(aei0.a());
        aeq aeq3 = new aeq("image");
        aeq3.b(2);
        aeq3.e(0);
        aeq3.c(0);
        aeq3.d(0);
        aef0.c(aeq3.a());
        aen aen0 = new aen("dateModified");
        aen0.b(2);
        aen0.c(0);
        aef0.c(aen0.a());
        aeq aeq4 = new aeq("identifier");
        aeq4.b(2);
        aeq4.e(0);
        aeq4.c(0);
        aeq4.d(0);
    ...
    public final afa b(Object object0) {
        aez aez0 = new aez(((MobileApplication)object0).q, ((MobileApplication)object0).p, "MobileApplication");
        aez0.b("name", new String[]{((MobileApplication)object0).r});
        List list0 = ((MobileApplication)object0).b();
        if(list0 != null) {
            aez0.b("keywords", ((String[])list0.toArray(new String[0])));
        }
        List list1 = ((MobileApplication)object0).a();
        if(list1 != null) {
            aez0.b("alternateName", ((String[])list1.toArray(new String[0])));
        }
        aez0.a("g3attrinfo", new afa[]{afa.f(((MobileApplication)object0).s)});
        aez0.b("image", new String[]{((MobileApplication)object0).a});
        aez0.k("dateModified", new long[]{((MobileApplication)object0).b});
        aez0.b("identifier", new String[]{((MobileApplication)object0).c});
        return aez0.e();
    }
    ...
    public final Object c(afa afa0, aew aew0) {
        ...
        String[] arr_s3 = afa0.u("image");
        String s4 = arr_s3 == null || arr_s3.length == 0 ? null : arr_s3[0];
        long v = afa0.d("dateModified");
        String[] arr_s4 = afa0.u("identifier");
        if(arr_s4 != null && arr_s4.length != 0) {
            s2 = arr_s4[0];
        }
        return new MobileApplication(s1, s, s3, list0, list1, s4, v, s2, g3AttributionInfo0);
    }
