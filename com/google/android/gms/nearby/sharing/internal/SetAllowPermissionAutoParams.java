...
public final class SetAllowPermissionAutoParams extends AbstractSafeParcelable {
    ...
    static {
        SetAllowPermissionAutoParams.CREATOR = new ddtr();
    }

    public SetAllowPermissionAutoParams() {
    }

    public SetAllowPermissionAutoParams(boolean z, IBinder iBinder0) {
        azxs azxs0;
        if(iBinder0 == null) {
            azxs0 = null;
        }
    ...
    public final boolean equals(Object object0) {
        return this == object0 ? true : (object0 instanceof SetAllowPermissionAutoParams) && bata.b(Boolean.valueOf(this.a), Boolean.valueOf(((SetAllowPermissionAutoParams)object0).a)) && bata.b(this.b, ((SetAllowPermissionAutoParams)object0).b);
    }
