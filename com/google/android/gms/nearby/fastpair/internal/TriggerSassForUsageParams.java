...
public final class TriggerSassForUsageParams extends AbstractSafeParcelable {
    ...
    static {
        TriggerSassForUsageParams.CREATOR = new cyjb();
    }

    private TriggerSassForUsageParams() {
    }

    public TriggerSassForUsageParams(int v, IBinder iBinder0) {
        cyhu cyhu0;
        if(iBinder0 == null) {
            cyhu0 = null;
        }
    ...
    public final boolean equals(Object object0) {
        return this == object0 ? true : (object0 instanceof TriggerSassForUsageParams) && bata.b(Integer.valueOf(this.a), Integer.valueOf(((TriggerSassForUsageParams)object0).a)) && bata.b(this.b, ((TriggerSassForUsageParams)object0).b);
    }
