...
public abstract class Pommel_PhotosOptInNotificationSenderTask extends GmsTaskBoundService implements eixj, ejbp {
    private volatile eizh a;
    private final Object b;
    private boolean c;

    public Pommel_PhotosOptInNotificationSenderTask() {
        this.b = new Object();
        this.c = false;
    }
    ...
    public final void onCreate() {
        if(!this.c) {
            this.c = true;
            ((assl)this.h()).b(((PhotosOptInNotificationSenderTask)this));
        }
        super.onCreate();
    }
}
