...
public class ActivityStartEvent extends AbstractSafeParcelable {
    ...
    static {
        ActivityStartEvent.CREATOR = new elut();
    }

    public ActivityStartEvent(float f, float f1, ActivityCandidate activityCandidate0, AdditionalActivityCandidates additionalActivityCandidates0) {
        this.a = f;
        this.b = f1;
    ...
    public final String toString() {
        return "ActivityStartEvent{probability=" + this.a + ", topCandidate=" + this.c + ", additionalActivityCandidates=" + this.d + "}";
    }
