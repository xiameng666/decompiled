...
public class ActivityOngoingEvent extends AbstractSafeParcelable {
    ...
    static {
        ActivityOngoingEvent.CREATOR = new elus();
    }

    public ActivityOngoingEvent(float f, float f1, ActivityCandidate activityCandidate0, AdditionalActivityCandidates additionalActivityCandidates0) {
        this.a = f;
        this.b = f1;
    ...
    public final String toString() {
        return "ActivityOngoingEvent{probability=" + this.a + ", topCandidate=" + this.c + ", additionalActivityCandidates=" + this.d + "}";
    }
