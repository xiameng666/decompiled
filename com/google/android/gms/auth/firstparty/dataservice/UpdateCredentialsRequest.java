...
public class UpdateCredentialsRequest extends AbstractSafeParcelable {
    ...
    static {
        UpdateCredentialsRequest.CREATOR = new ajoo();
    }
    ...
    public UpdateCredentialsRequest(int v, AccountCredentials accountCredentials0, CaptchaSolution captchaSolution0) {
        this.a = v;
