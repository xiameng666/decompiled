...
public class DeleteBytesRequest extends AbstractSafeParcelable {
    ...
    static {
        DeleteBytesRequest.CREATOR = new ainn();
    }

    public DeleteBytesRequest(List list0, boolean z) {
        boolean z1 = true;
        super();
        if(z) {
            ...
            batl.m(z1, "deleteAll was set to true but other constraint(s) was also provided: keys");
        }
        this.a = z;
