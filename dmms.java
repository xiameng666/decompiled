...
final class dmms implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public dmms(dola dola0, dlmk dlmk0, dmox dmox0, domw domw0) {
        this.f = dlmk0;
        this.g = dmox0;
        dolc dolc0 = new dolc(dola0);
        this.a = dolc0;
        dmmr dmmr0 = new dmmr(domw0);
        this.b = dmmr0;
        dlny dlny0 = new dlny(dlni.a, dmmr0);
        this.c = dlny0;
    ...
    public final void inject(Object object0) {
        ...
        dlnj.a();
        dmos0.a = dmom.a(new lso(xni0, new dmpf(dmmx0, dmou0, ibrt0, context0, new dmnv(ggeo0, s, new dmgk(dmgy.a())))));
        dmos0.b = new edon(dlnj.a());
        dmos0.c = (dsoz)this.e.get();
    }
}
