...
public final class cnql implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v1)) {
                ...
                case 2: {
                    list0 = baua.y(parcel0, v1, UserPlace.CREATOR);
                    break;
                }
                default: {
                    baua.C(parcel0, v1);
        ...
        baua.A(parcel0, v);
        return new UserPlacesResult(status0, list0);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new UserPlacesResult[v];
    }
}
