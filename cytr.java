...
public final class cytr extends cjtm {
    private final CreateAccountKeyInternalParams a;
    private final String b;
    private final byte[] c;

    public cytr(CreateAccountKeyInternalParams createAccountKeyInternalParams0, String s, byte[] arr_b) {
        super(0x109, "CreateAccountKeyInternal");
        this.a = createAccountKeyInternalParams0;
        this.b = s;
        this.c = arr_b;
    }
