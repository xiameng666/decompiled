...
public final class cyzi extends czew implements czaq {
    private final azyf a;
    private final Set b;
    private final Set c;

    public cyzi(azyf azyf0) {
        this.b = new bxf();
        this.c = new bxf();
        this.a = azyf0;
    }
    ...
    public final void a(OnBandwidthChangedParams onBandwidthChangedParams0) {
        ...
        cyzc cyzc0 = new cyzc(this, onBandwidthChangedParams1, onBandwidthChangedParams0);
        this.a.b(cyzc0);
    }
    ...
    public final void c(OnConnectionInitiatedParams onConnectionInitiatedParams0) {
        synchronized(this) {
            ...
            this.b.add(cuwd0);
            cyyz cyyz0 = new cyyz(this, onConnectionInitiatedParams0);
            this.a.b(cyyz0);
        }
    }
    ...
    public final void d(OnConnectionResultParams onConnectionResultParams0) {
        ...
        synchronized(this) {
            ...
            cyza cyza0 = new cyza(this, onConnectionResultParams1, status0);
            this.a.b(cyza0);
        }
    }
    ...
    public final void e(OnDisconnectedParams onDisconnectedParams0) {
        synchronized(this) {
            ...
            this.c.remove(cuwd0);
            cyzb cyzb0 = new cyzb(this, onDisconnectedParams0);
            this.a.b(cyzb0);
        }
    }
    ...
    public final void f(OnEndpointIdRotatedParams onEndpointIdRotatedParams0) {
        cyze cyze0 = new cyze(this, onEndpointIdRotatedParams0);
        this.a.b(cyze0);
    }

    @Override  // czex
    public final void g(OnEndpointIdRotationParams onEndpointIdRotationParams0) {
        cyzd cyzd0 = new cyzd(this, onEndpointIdRotationParams0);
        this.a.b(cyzd0);
    }

    @Override  // czex
    public final void h(OnInternetConnectionChangedParams onInternetConnectionChangedParams0) {
        cyzf cyzf0 = new cyzf(this, onInternetConnectionChangedParams0);
        this.a.b(cyzf0);
    }
    ...
    public final void i() {
        synchronized(this) {
            ...
            while(bxe0.hasNext()) {
                ...
                cyzg cyzg0 = new cyzg(this, ((cuwd)object0));
                this.a.b(cyzg0);
            }
            set0.clear();
            Set set1 = this.c;
            ...
            while(bxe1.hasNext()) {
                ...
                cyzh cyzh0 = new cyzh(this, ((cuwd)object1));
                this.a.b(cyzh0);
            }
            set1.clear();
        }
