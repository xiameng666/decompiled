...
final class ebkf implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebkf(dola dola0, dmgr dmgr0, domw domw0, domv domv0, edor edor0) {
        this.r = domv0;
        this.s = domw0;
        this.t = dola0;
        this.u = dmgr0;
        ebkd ebkd0 = new ebkd(domv0);
        this.a = ebkd0;
        ebkc ebkc0 = new ebkc(domv0);
        this.b = ebkc0;
        eczr eczr0 = new eczr(ebkd0, ebkc0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(ebkd0);
        this.e = ecwf0;
        this.f = ebkg.a;
        ecwe ecwe0 = new ecwe(ebkd0, ebkg.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(ebkd0, eczr0, ecwf0, ecwe0, ebkg.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(ebkd0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(ebkd0);
        this.m = dmkm0;
        ebke ebke0 = new ebke(edor0);
        this.n = ebke0;
        edrn edrn0 = new edrn(edsf0, dmkm0, ebke0);
        this.o = edrn0;
