...
public final class dfwt implements Runnable {
    public final dfzz a;
    public final dfso b;
    public final QrCodeMetadata c;
    public final String d;

    public dfwt(dfzz dfzz0, dfso dfso0, QrCodeMetadata qrCodeMetadata0, String s) {
        this.a = dfzz0;
        this.b = dfso0;
    ...
    public final void run() {
        ...
        String s = this.d;
        int v2 = dfvp0.M(dfzz0.bH(dfso0.e, s, arr_b, v, dcpv0), dfzz0, dfso1);
        if(v2 == 0) {
            dfzz0.r = dftl0;
