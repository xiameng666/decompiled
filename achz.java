...
public final class achz implements Iterable {
    private final List a;

    public achz(String s) {
    ...
    public final achy b(int v) {
        return (achy)this.a.get(v);
    }
    ...
    label_13:
        ...
        if(v == -1) {
            achy achy0 = new achy(s, -1);
            this.a.add(achy0);
            return;
        }
        if(!z) {
            s1 = s.substring(v + 1);
            this.a.add(new achy(s.substring(0, v), -1));
            this.c(s1);
            return;
        }
        Objects.requireNonNull(s);
    ...
    public final boolean equals(Object object0) {
        ...
        return (object0 instanceof achz) ? Objects.equals(this.a, ((achz)object0).a) : false;
    }
