...
final class ebls implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebls(dola dola0, dmgr dmgr0, domw domw0, domv domv0, edor edor0) {
        this.r = domv0;
        this.s = domw0;
        this.t = dola0;
        this.u = dmgr0;
        eblq eblq0 = new eblq(domv0);
        this.a = eblq0;
        eblp eblp0 = new eblp(domv0);
        this.b = eblp0;
        eczr eczr0 = new eczr(eblq0, eblp0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(eblq0);
        this.e = ecwf0;
        this.f = eblt.a;
        ecwe ecwe0 = new ecwe(eblq0, eblt.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(eblq0, eczr0, ecwf0, ecwe0, eblt.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(eblq0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(eblq0);
        this.m = dmkm0;
        eblr eblr0 = new eblr(edor0);
        this.n = eblr0;
        edrn edrn0 = new edrn(edsf0, dmkm0, eblr0);
        this.o = edrn0;
