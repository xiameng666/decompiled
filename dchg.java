...
final class dchg implements dcnp {
    final ddpr a;
    final dchp b;
    private final cumy c;

    public dchg(dchp dchp0, ddpr ddpr0) {
        this.a = ddpr0;
    ...
    public final void e(ShareTarget shareTarget0, TransferMetadata transferMetadata0) {
        ...
        try {
            ...
            dcvz.a.e().f(remoteException0).p("Failed to invoke onTransferUpdate on registered send surface.", new Object[0]);
        }
    }
}
