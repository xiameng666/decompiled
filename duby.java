...
final class duby implements AndroidInjector {
    private final doly a;
    private final dolg b;
    private final dxed c;
    private final dpsz d;

    public duby(dolg dolg0, dpsz dpsz0, dxed dxed0, doly doly0) {
        this.a = doly0;
        this.d = dpsz0;
        this.b = dolg0;
        this.c = dxed0;
    ...
    public final void inject(Object object0) {
        ...
        bbic.a();
        new dotf(bblp1);
        dugj0.b = dvfi.a(new lso(xni0, new dvfj(bblp0, cqxc0, dtpl0, dual0, dtyl0, lps0, dtph0, dtrf0, new dubj(new etgl(this.a.e())), new dtyw(this.d.a(), this.c()))));
        dugj0.c = new dtzg(dmgy.a(), edtn.a());
    }
}
