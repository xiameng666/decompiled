...
public final class ahkd extends ArrayAdapter {
    public ahkd(Context context0, List list0) {
    ...
    public final View getView(int v, View view0, ViewGroup viewGroup0) {
        ...
        Account account0 = (Account)this.getItem(v);
        batl.s(account0);
        ahjc ahjc0 = new ahjc();
        ahjc0.b(2);
        ahjc0.d = account0.name;
        ((AccountChipView)view0).b(new ahjd(ahjc0));
