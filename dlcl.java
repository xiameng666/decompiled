...
public final class dlcl implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new DataChangeListenerRequest(account0, dataChangeListenerType0, s);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new DataChangeListenerRequest[v];
    }
}
