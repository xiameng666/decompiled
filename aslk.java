...
public final class aslk implements View.OnClickListener {
    public final cmeb a;
    public final StorageMeterPreference b;
    public final String c;

    public aslk(cmeb cmeb0, StorageMeterPreference storageMeterPreference0, String s) {
        this.a = cmeb0;
    ...
    public final void onClick(View view0) {
        ...
        if(ibts0 != null) {
            String s = hqky.a.b().a();
            ibuq.e(s, "storageMeterCleanUpSpaceUrl(...)");
