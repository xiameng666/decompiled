...
public final class cqxr implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new StoreMdocMetadataRequest(account0, provisioningId0, arr_b);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new StoreMdocMetadataRequest[v];
    }
}
