...
public final class ifrj implements Key, PublicKey {
    private transient ifja a;
    private transient String b;
    private transient byte[] c;
    private static final long serialVersionUID = 1L;

    public ifrj(idzh idzh0) {
        this.a(idzh0);
    }

    private final void a(idzh idzh0) {
        ifja ifja0 = (ifja)ifpl.a(idzh0);
        this.a = ifja0;
        this.b = ifuf.c(ifja0.b.c);
    }
    ...
    public final boolean equals(Object object0) {
        ...
        return (object0 instanceof ifrj) ? Arrays.equals(this.getEncoded(), ((ifrj)object0).getEncoded()) : false;
    }
