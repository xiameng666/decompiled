...
public final class fawi implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v1)) {
                ...
                case 4: {
                    proxyCard0 = (ProxyCard)baua.m(parcel0, v1, ProxyCard.CREATOR);
                    break;
                }
                case 5: {
        ...
        baua.A(parcel0, v);
        return new FullWallet(s, s1, proxyCard0, s2, address0, address1, arr_s, userAddress0, userAddress1, arr_instrumentInfo, paymentMethodToken0);
    }
