...
final class eblc implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public eblc(dola dola0, dmgr dmgr0, domw domw0, domv domv0, edor edor0) {
        this.r = domv0;
        this.s = domw0;
        this.t = dola0;
        this.u = dmgr0;
        ebla ebla0 = new ebla(domv0);
        this.a = ebla0;
        ebkz ebkz0 = new ebkz(domv0);
        this.b = ebkz0;
        eczr eczr0 = new eczr(ebla0, ebkz0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(ebla0);
        this.e = ecwf0;
        this.f = ebld.a;
        ecwe ecwe0 = new ecwe(ebla0, ebld.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(ebla0, eczr0, ecwf0, ecwe0, ebld.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(ebla0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(ebla0);
        this.m = dmkm0;
        eblb eblb0 = new eblb(edor0);
        this.n = eblb0;
        edrn edrn0 = new edrn(edsf0, dmkm0, eblb0);
        this.o = edrn0;
