...
final class ebra implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebra(dola dola0, dmgr dmgr0, domw domw0, domv domv0, edor edor0) {
        this.r = dola0;
        this.s = domv0;
        this.t = domw0;
        this.u = dmgr0;
        ebqy ebqy0 = new ebqy(domv0);
        this.a = ebqy0;
        ebqx ebqx0 = new ebqx(domv0);
        this.b = ebqx0;
        eczr eczr0 = new eczr(ebqy0, ebqx0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(ebqy0);
        this.e = ecwf0;
        this.f = ebrb.a;
        ecwe ecwe0 = new ecwe(ebqy0, ebrb.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(ebqy0, eczr0, ecwf0, ecwe0, ebrb.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(ebqy0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(ebqy0);
        this.m = dmkm0;
        ebqz ebqz0 = new ebqz(edor0);
        this.n = ebqz0;
        edrn edrn0 = new edrn(edsf0, dmkm0, ebqz0);
        this.o = edrn0;
    ...
    public final void inject(Object object0) {
        ebzt ebzt0 = (ebzt)object0;
        ebzt0.a = new dytd(dolc.b(this.r), new dypj(this.i(), new dypb(this.i(), this.h()), new edmh(this.s.a(), dmgy.a(), easm.a()), new dybv(), new bblp(0x7FFFFFFF, 10)), this.e(), this.d(), this.f(), this.g(), new dycb(this.s.a(), dolc.b(this.r), dmgy.a()), this.h(), this.c(), easp.a(), new bblp(0x7FFFFFFF, 10), new bblp(0x7FFFFFFF, 9), this.j());
        ebzt0.f = eczo.b(this.s.a());
        ebzt0.b = this.d();
        ebzt0.c = this.j();
        ebzt0.d = dolf.b(this.r);
    }
