...
public final class caks extends AbstractProducesMethodProducer {
    private final Producer b;
    private final Producer c;
    private final Producer d;

    public caks(Provider provider0, Provider provider1, Producer producer0, Producer producer1, Producer producer2) {
        super(provider1, new ProducerToken(caks.class), provider0);
    ...
    public final gmcd b(Object object0) {
        ...
        cann cann0 = (cann)list0.get(1);
        canh canh0 = (canh)list0.get(2);
        return cako.a(caoj0, cann0, caok.a, 7, canh0);
    }
