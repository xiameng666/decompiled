...
public final class dlew implements Parcelable.Creator {
    @Override  // android.os.Parcelable$Creator
    public final Object createFromParcel(Parcel parcel0) {
        int v = baua.h(parcel0);
        Account account0 = null;
        ProtoSafeParcelable protoSafeParcelable0 = null;
        FetchMode fetchMode0 = null;
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v1)) {
                ...
                case 3: {
                    fetchMode0 = (FetchMode)baua.m(parcel0, v1, FetchMode.CREATOR);
                    break;
                }
                default: {
                    baua.C(parcel0, v1);
        ...
        baua.A(parcel0, v);
        return new GetSettingsRequest(account0, protoSafeParcelable0, fetchMode0);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new GetSettingsRequest[v];
    }
}
