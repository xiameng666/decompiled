...
import com.google.android.gms.multidevice.service.MultideviceModuleInitIntentOperation;

public class ctfc extends avzf implements eixj, ejbp {
    ...
    public final void onCreate() {
        if(!this.c) {
            this.c = true;
            ((ctey)this.h()).j(((MultideviceModuleInitIntentOperation)this));
        }
    }
}
