...
final class ebmw implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebmw(dola dola0, dmgr dmgr0, domw domw0, domv domv0, edor edor0) {
        this.r = domv0;
        this.s = domw0;
        this.t = dola0;
        this.u = dmgr0;
        ebmu ebmu0 = new ebmu(domv0);
        this.a = ebmu0;
        ebmt ebmt0 = new ebmt(domv0);
        this.b = ebmt0;
        eczr eczr0 = new eczr(ebmu0, ebmt0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(ebmu0);
        this.e = ecwf0;
        this.f = ebmx.a;
        ecwe ecwe0 = new ecwe(ebmu0, ebmx.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(ebmu0, eczr0, ecwf0, ecwe0, ebmx.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(ebmu0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(ebmu0);
        this.m = dmkm0;
        ebmv ebmv0 = new ebmv(edor0);
        this.n = ebmv0;
        edrn edrn0 = new edrn(edsf0, dmkm0, ebmv0);
        this.o = edrn0;
