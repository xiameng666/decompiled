...
public final class cszp implements ldr {
    ...
    public final Object a() {
        ProtoLiteBuilder hftp0 = ((ProtoLiteMessage)cten.a).v_newBuilder();
    ...
    public final Object b(InputStream inputStream0) {
        ...
        ProtoLiteMessage hftv0 = ((ProtoLiteMessage)cten.a).x_newMutableInstance();
        try {
        ...
        ibuq.e(((cten)hftv0), "parseFrom(...)");
        return (cten)hftv0;
    }

    @Override  // ldr
    public final Object c(Object object0, OutputStream outputStream0) {
        ((cten)object0).writeToStream(outputStream0);
        return ibom.a;
    }
}
