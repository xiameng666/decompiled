...
public final class cyuj extends cjtm {
    private final UnpairDeviceParams a;
    private final String b;
    private final byte[] c;

    public cyuj(UnpairDeviceParams unpairDeviceParams0, String s, byte[] arr_b) {
        super(0x109, "UnpairDevice");
        this.a = unpairDeviceParams0;
        this.b = s;
        this.c = arr_b;
    }
