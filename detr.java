final class detr implements ibtx {
    final devp a;
    final ibts b;
    final gra c;
    final ibth d;
    ...
    public detr(devp devp0, ibts ibts0, gra gra0, gei gei0, ibth ibth0, ibth ibth1, gra gra1) {
        this.a = devp0;
        this.b = ibts0;
        this.c = gra0;
        this.g = gei0;
    ...
    public final Object a(Object object0, Object object1, Object object2) {
        ...
        ibuq.f(((dlp)object0), "$this$ScrollableScaffold");
        if((v & 17) == 16 && ((goz)object1).ac()) {
            ((goz)object1).G();
            return ibom.a;
        }
        ((goz)object1).M(1671500447);
        devp devp0 = this.a;
        if(devp0.c == deco.a) {
            ibts ibts0 = this.b;
