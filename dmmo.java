...
final class dmmo implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public dmmo(dola dola0, dlmk dlmk0, dmox dmox0, domw domw0) {
        this.f = dlmk0;
        this.g = dmox0;
        dolc dolc0 = new dolc(dola0);
        this.a = dolc0;
        dmmn dmmn0 = new dmmn(domw0);
        this.b = dmmn0;
        dlny dlny0 = new dlny(dlni.a, dmmn0);
        this.c = dlny0;
    ...
    public final void inject(Object object0) {
        ...
        dlnj.a();
        dmnu0.a = dmom.a(new lso(xni0, new dmpf(dmmx0, dmou0, ibrt0, context0, new dmnv(ggeo0, s, new dmgk(dmgy.a())))));
        dmnu0.b = (dsoz)this.e.get();
    }
}
