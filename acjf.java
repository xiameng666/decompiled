...
public final class acjf implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        String s = null;
        String s1 = null;
        GetByDocumentIdRequest getByDocumentIdRequest0 = null;
        ...
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v2)) {
                ...
                case 4: {
                    getByDocumentIdRequest0 = (GetByDocumentIdRequest)baua.m(parcel0, v2, GetByDocumentIdRequest.CREATOR);
                    break;
                }
                case 5: {
        ...
        baua.A(parcel0, v);
        return new GetDocumentsAidlRequest(appSearchAttributionSource0, s, s1, getByDocumentIdRequest0, userHandle0, v1, z);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new GetDocumentsAidlRequest[v];
    }
}
