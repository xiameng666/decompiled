...
public final class cakz extends AbstractProducesMethodProducer {
    ...
    public cakz(Provider provider0, Provider provider1, Producer producer0, Producer producer1, Provider provider2, Provider provider3, Provider provider4, Provider provider5, Provider provider6, Producer producer2) {
        super(provider1, new ProducerToken(cakz.class), provider0);
    ...
    public final gmcd b(Object object0) {
        ...
        Provider provider0 = this.g;
        Provider provider1 = this.f;
        ...
        if(huhz.n()) {
            ((ggtj)caky.a.j()).x("MediaStore access denied or indexing disabled");
        }
        ((canl)this.h).a().c();
    ...
    protected final gmcd c() {
        return gmbu.f(new gmcd[]{this.b.get(), this.i.get()});
    }
}
