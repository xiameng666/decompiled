final class ggbk extends ggbl {
    private static final long serialVersionUID;

    public ggbk(Comparable comparable0) {
    ...
    public final ggbl d(gfzd gfzd0, ggbv ggbv0) {
        switch(gfzd0.ordinal()) {
            case 0: {
                Comparable comparable0 = ggbv0.b(this.b);
                return comparable0 == null ? ggbj.a : new ggbi(comparable0);
            }
            case 1: {
                return this;
            }
    ...
    public final ggbl e(gfzd gfzd0, ggbv ggbv0) {
        switch(gfzd0.ordinal()) {
            ...
            case 1: {
                Comparable comparable0 = ggbv0.b(this.b);
                return comparable0 == null ? ggbh.a : new ggbi(comparable0);
            }
            default: {
                throw new AssertionError();
            }
