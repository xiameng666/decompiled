public final class boso implements gfsi {
    public final boul a;
    public final hfwn b;

    public boso(boul boul0, hfwn hfwn0) {
        this.a = boul0;
        this.b = hfwn0;
    }
    ...
    public final Object apply(Object object0) {
        ...
        ((fqzk)((fqzg)hftp0).b_message).d = 1;
        ((fqzk)((fqzg)hftp0).b_message).b |= 2;
        if(!((fqzg)hftp0).b_message.isImmutable()) {
            ((ProtoLiteBuilder)(((fqzg)hftp0))).ensureMutable();
        }
        ((fqzk)((fqzg)hftp0).b_message).e = hfty.a;
        if(!((fqzg)hftp0).b_message.isImmutable()) {
            ((ProtoLiteBuilder)(((fqzg)hftp0))).ensureMutable();
        }
