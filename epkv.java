...
public final class epkv implements ibts {
    public final acp a;
    public final SuggestionListChimeraActivity b;

    public epkv(acp acp0, SuggestionListChimeraActivity suggestionListChimeraActivity0) {
        this.a = acp0;
        this.b = suggestionListChimeraActivity0;
    }
