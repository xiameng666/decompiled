...
public final class ajkm extends cjtm {
    ...
    static {
        ajkm.e = new baun(new String[]{"VerifyDecryptOperation"}, null);
    }

    public ajkm(ajin ajin0, String s, Account account0, Payload payload0, azug azug0) {
        super(0x81, "VerifyDecryptOperation", azug0);
        this.a = ajin0;
        this.b = s;
        this.c = account0;
        this.d = payload0;
    ...
    protected final void f(Context context0) {
        ...
        try {
            PlainText plainText0 = ajiy0.b(this.b, this.c, this.d);
            ajip0.b = 1;
            ajip0.a();
            ...
            ajkm.e.g("Failed to verifyDecrypt payload", ajgp0, new Object[0]);
            ajip0.a();
