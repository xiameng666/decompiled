...
final class ebpa implements AndroidInjector {
    final Provider a;
    final Provider b;
    final Provider c;
    final Provider d;
    ...
    public ebpa(dola dola0, dmgr dmgr0, domw domw0, domv domv0, edor edor0) {
        this.r = dola0;
        this.s = domv0;
        this.t = domw0;
        this.u = dmgr0;
        eboy eboy0 = new eboy(domv0);
        this.a = eboy0;
        ebox ebox0 = new ebox(domv0);
        this.b = ebox0;
        eczr eczr0 = new eczr(eboy0, ebox0);
        this.c = eczr0;
        this.d = new ecwg();
        ecwf ecwf0 = new ecwf(eboy0);
        this.e = ecwf0;
        this.f = ebpb.a;
        ecwe ecwe0 = new ecwe(eboy0, ebpb.a);
        this.g = ecwe0;
        ecwr ecwr0 = new ecwr(eboy0, eczr0, ecwf0, ecwe0, ebpb.a);
        this.h = ecwr0;
        ...
        edsf edsf0 = new edsf(eboy0);
        this.l = edsf0;
        dmkm dmkm0 = new dmkm(eboy0);
        this.m = dmkm0;
        eboz eboz0 = new eboz(edor0);
        this.n = eboz0;
        edrn edrn0 = new edrn(edsf0, dmkm0, eboz0);
        this.o = edrn0;
    ...
    public final void inject(Object object0) {
        ebyc ebyc0 = (ebyc)object0;
        ebyc0.a = new dytd(dolc.b(this.r), new dypj(this.i(), new dypb(this.i(), this.h()), new edmh(this.s.a(), dmgy.a(), easm.a()), new dybv(), new bblp(0x7FFFFFFF, 10)), this.e(), this.d(), this.f(), this.g(), new dycb(this.s.a(), dolc.b(this.r), dmgy.a()), this.h(), this.c(), easp.a(), new bblp(0x7FFFFFFF, 10), new bblp(0x7FFFFFFF, 9), this.j());
        ebyc0.b = new ebwl(this.a(), gfug.c(ecwh.a()));
    }
