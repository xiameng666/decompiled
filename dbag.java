...
public final class dbag implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new BroadcastWithIntentParams(iBinder0, pendingIntent0, presenceIdentity0, arr_presenceAction);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new BroadcastWithIntentParams[v];
    }
}
