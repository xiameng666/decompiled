...
public final class aqcu implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new AwarenessPlaceEntity(s, list0, s1, s2, s3, list1, latLng0, f, latLngBounds0, s4, uri0, z, f1, v1, s5);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new AwarenessPlaceEntity[v];
    }
}
