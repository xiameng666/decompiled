...
public abstract class bgvb extends SettingInjectorService implements eixj, ejbp {
    private volatile eizi a;
    private final Object b;
    private boolean c;

    public bgvb(String s) {
        super(s);
        this.b = new Object();
        this.c = false;
    }
    ...
    public final void onCreate() {
        if(!this.c) {
            this.c = true;
            ((bgtw)this.h()).c(((CrisisAlertsSettingChimeraInjectorService)this));
        }
        super.onCreate();
    }
}
