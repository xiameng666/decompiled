...
final class gxxp implements gxxt {
    final int a;
    final long b;
    final jqt c;

    public gxxp(gxxu gxxu0, int v, long v1, jqt jqt0) {
        this.a = v;
        this.b = v1;
        this.c = jqt0;
    ...
    public final void d(int v, BluetoothProfile bluetoothProfile0) {
        int v1 = this.a;
        if(v == v1 && bluetoothProfile0 != null) {
            ((ggtj)((ggtj)gxxg.a.h()).ar(20062)).G("BTConnStateMgr: tryReconnectProxy reconnect profile %d successful. Latency=%dms", v1, Instant.now().minusMillis(this.b).toEpochMilli());
