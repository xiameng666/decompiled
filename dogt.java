public final class dogt implements dohd {
    public final fsyk a;
    private final boolean b;
    private final String c;

    public dogt(fsyk fsyk0, boolean z) {
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof dogt)) {
            return false;
        }
        return ibuq.m(this.a, ((dogt)object0).a) ? this.b == ((dogt)object0).b : false;
    }
    ...
    public final String toString() {
        return "CardCentricItem(closedLoopCard=" + this.a + ", canBeDraggedToReorder=" + this.b + ")";
    }
}
