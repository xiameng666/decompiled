...
import com.google.android.gms.credential.manager.credentialexchange.OsmosisCredentialExchangeChimeraService;

public abstract class bdom extends Service implements eixj, ejbp {
    ...
    public void onCreate() {
        if(!this.c) {
            this.c = true;
            ((bdmk)this.h()).f(((OsmosisCredentialExchangeChimeraService)this));
        }
        super.onCreate();
    }
}
