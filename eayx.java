...
final class eayx implements AndroidInjector {
    ...
    public eayx(dola dola0, dmgr dmgr0, domw domw0, domv domv0, domq domq0) {
        this.a = dola0;
        this.b = domv0;
        this.c = dmgr0;
        this.d = domq0;
    ...
    public final void inject(Object object0) {
        ...
        ((ebcc)object0).a = new ecga(account0, dlmc0, context0, azts0, etgl0, new ecgd(dmhh.b(context1, s, s1, s2, this.c.a, Optional.empty()), fpfv0), bblp0, easx0, dlnm0, dmgi0, this.a.c);
    }
}
