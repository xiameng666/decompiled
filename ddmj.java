...
import com.google.android.gms.nearby.sharing.flagmonitor.FlagMonitorIntentOperation;

public class ddmj extends IntentOperation implements eixj, ejbp {
    ...
    public final void onCreate() {
        if(!this.c) {
            this.c = true;
            ((ddmi)this.h()).a(((FlagMonitorIntentOperation)this));
        }
    }
}
