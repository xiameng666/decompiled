...
public final class ifsj implements Key, PrivateKey {
    private transient idqg a;
    private transient ifnx b;
    private transient idqy c;
    private static final long serialVersionUID = 1L;

    public ifsj(idvk idvk0) {
        this.a(idvk0);
    }

    private final void a(idvk idvk0) {
        this.c = idvk0.c;
        this.a = ifhs.a(idvk0.b.b).a.a;
        this.b = (ifnx)ifoj.a(idvk0);
    }

    @Override
    public final boolean equals(Object object0) {
        return object0 == this ? true : (object0 instanceof ifsj) && this.a.y(((ifsj)object0).a) && Arrays.equals(this.b.a(), ((ifsj)object0).b.a());
    }
