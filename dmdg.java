...
public final class dmdg {
    public gfsx a;
    private final dmdc b;

    public dmdg(dmdc dmdc0) {
        this.a = gfqx.a;
        this.b = dmdc0;
    }
    ...
    public final boolean b() {
        this.a();
        return this.a.i() && !((ftoz)this.a.d()).c.isEmpty() && !((ftoz)this.a.d()).b.isEmpty() && ((ftoz)this.a.d()).d != 0L;
    }
}
