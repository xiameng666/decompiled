...
import com.google.android.gms.crisisalerts.init.CrisisAlertsPersistentChimeraService;

public abstract class bgrp extends Service implements eixj, ejbp {
    ...
    public void onCreate() {
        if(!this.c) {
            this.c = true;
            ((bgrn)this.h()).b(((CrisisAlertsPersistentChimeraService)this));
        }
        super.onCreate();
    }
}
