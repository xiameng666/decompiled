...
public final class cytu extends cjtm {
    private final GetDeviceInfoParams a;
    private final String b;
    private final byte[] c;

    public cytu(GetDeviceInfoParams getDeviceInfoParams0, String s, byte[] arr_b) {
        super(0x109, "GetDeviceInfo");
        this.a = getDeviceInfoParams0;
        this.b = s;
        this.c = arr_b;
    }
