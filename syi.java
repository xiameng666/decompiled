...
public class syi implements Serializable {
    public byte[] a;
    ...
    public final boolean equals(Object object0) {
        return (object0 instanceof syi) ? Arrays.equals(this.a, ((syi)object0).f()) : false;
    }
    ...
    public final byte[] g() {
        ...
        if(v != 2) {
            switch(v) {
                ...
                default: {
                    if(v != 6) {
                        throw new IllegalStateException("Implementation fault detected in " + syi.class.toString());
                    }
                    goto label_7;
                }
            }
    ...
    private final IllegalArgumentException k() {
        return this.a == null ? new IllegalArgumentException("APDU encoding is invalid (, not according ISO 7816). null") : new IllegalArgumentException("APDU encoding is invalid (, not according ISO 7816). " + tek.b(this.a));
    }

    @Override
    public final String toString() {
        return this.j().h + ": " + tek.c(this.a, false);
    }
}
