...
public final class caqn implements acn, ibum {
    final KidsAuthAddAccountChimeraActivity a;

    public caqn(KidsAuthAddAccountChimeraActivity kidsAuthAddAccountChimeraActivity0) {
    ...
    @Override  // ibum
    public final ibnk b() {
        return new ibuo(1, this.a, KidsAuthAddAccountChimeraActivity.class, "handleKidSetupResult", "handleKidSetupResult(Landroidx/activity/result/ActivityResult;)V", 0);
    }
