...
public final class beyi implements ibts {
    public final String a;
    public final bezz b;

    public beyi(String s, bezz bezz0) {
        this.a = s;
        this.b = bezz0;
    }
    ...
    public final Object a(Object object0) {
        ...
        textView0.setText(textView0.getResources().getQuantityString(0x7F13005B, this.b.a.size(), new Object[]{this.b.a.size()}));  // plurals:pwm_import_result_imported_passwords_count
        textView0.setVisibility(0);
        TextView textView1 = (TextView)view0.findViewById(0x7F0B1DB2);  // id:pwm_import_status_invalid_passwords_count
        textView1.setText(textView1.getResources().getQuantityString(0x7F13005C, this.b.b.size(), new Object[]{this.b.b.size()}));  // plurals:pwm_import_result_not_imported_passwords_count
