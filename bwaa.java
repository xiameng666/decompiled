...
public final class bwaa implements ibth {
    public final SummaryCard a;

    public bwaa(SummaryCard summaryCard0) {
        this.a = summaryCard0;
    }
    ...
    public final Object a() {
        ...
        if(!bwdm0.h()) {
            ...
            ((jtc)object0).h(0x7F0B23B5, 6, 0, 6);  // id:uiflow_summary_card_cta
        }
        ...
        ((jtc)object0).h(0x7F0B23B9, 7, 0, 7);  // id:uiflow_summary_card_expanded_media_container
        bwea.e(((jtc)object0), summaryCard0.getWidth());
        TypedValue typedValue0 = new TypedValue();
        summaryCard0.getContext().getTheme().resolveAttribute(0x7F040218, typedValue0, true);  // attr:cardLottieRatioConstraintsHeight
        ((jtc)object0).o(0x7F0B23B9, typedValue0.string.toString());  // id:uiflow_summary_card_expanded_media_container
        int v5 = summaryCard0.j();
        ((jtc)object0).i(0x7F0B23BC, 3, 0x7F0B23B9, 4, v5 + v5);  // id:uiflow_summary_card_title
        ((jtc)object0).i(0x7F0B23B6, 3, 0x7F0B23B9, 4, summaryCard0.j());  // id:uiflow_summary_card_expand_button
        ((jtc)object0).i(0x7F0B23BC, 6, 0, 6, summaryCard0.i());  // id:uiflow_summary_card_title
        ((jtc)object0).i(0x7F0B23B7, 6, 0, 6, summaryCard0.i());  // id:uiflow_summary_card_expanded_body
        ((jtc)object0).i(0x7F0B23BA, 6, 0, 6, summaryCard0.i());  // id:uiflow_summary_card_feature_disclaimer
        return object0;
    }
}
