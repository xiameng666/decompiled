...
public final class azne implements azme {
    private final long a;
    private final azmd b;

    public azne(long v, azmd azmd0) {
        this.a = v;
        this.b = azmd0;
    }
    ...
    public final Map a(gged_interceptors gged0) {
        ...
        for(int v = 0; v < ((ggna)gged0).c; ++v) {
            ...
            if(aznh0 != null) {
                ...
                hashMap0.put(azki0, new aznh(aznh0.a, azii0));
            }
        ...
        for(Object object0: hashMap0.entrySet()) {
            ((Map)Map.-EL.computeIfAbsent(map0, ((aznh)((Map.Entry)object0).getValue()).a, new aznd())).put(((azki)((Map.Entry)object0).getKey()), ((aznh)((Map.Entry)object0).getValue()).b);
        }
        return map0;
    }
}
