...
public final class cqwy implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        baua.A(parcel0, v);
        return new MakeCryptoSchemeRequest(account0, provisioningId0, arr_b);
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new MakeCryptoSchemeRequest[v];
    }
}
