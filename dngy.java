...
public final class dngy implements View.OnClickListener {
    public final dnhi a;
    public final dxev b;

    public dngy(dnhi dnhi0, dxev dxev0) {
        this.a = dnhi0;
        this.b = dxev0;
    }
    ...
    public final void onClick(View view0) {
        ...
        gtfc0.c = hfsf0;
        ibuq.e(hftp0, "apply(...)");
        int v = ((SwitchCompat)view0.findViewById(0x7F0B0868)).isChecked() ? 4 : 5;  // id:Switch
        ...
        ibuq.e(hftv1, "build(...)");
        ibuq.c(view0);
        dnhh dnhh0 = new dnhh(this.a, view0);
        dptv.l(this.a.e, dpuj.cc, ((MessageLite)(((gtpc)hftv1))), ((MessageLite)gtpd.a), dnhh0);
    }
}
