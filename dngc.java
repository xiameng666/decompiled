...
public final class dngc implements View.OnClickListener {
    public final dngl a;
    public final hkgs b;
    public final hjqa c;
    public final hjwp d;

    public dngc(dngl dngl0, hkgs hkgs0, hjqa hjqa0, hjwp hjwp0) {
        this.a = dngl0;
        this.b = hkgs0;
        this.c = hjqa0;
        this.d = hjwp0;
    ...
    public final void onClick(View view0) {
        ...
        if(this.c.e.equals("com.google.android.apps.nbu.paisa.user")) {
