...
public final class beud implements ldr {
    @Override  // ldr
    public final Object a() {
        return bgow.a(((ProtoLiteMessage)bgov.a).v_newBuilder()).a();
    }

    @Override  // ldr
    public final Object b(InputStream inputStream0) {
        hfsl hfsl0 = hfsl.N(inputStream0);
        ProtoLiteMessage hftv0 = ((ProtoLiteMessage)bgov.a).x_newMutableInstance();
        try {
        ...
        ibuq.e(((bgov)hftv0), "parseFrom(...)");
        return (bgov)hftv0;
    }

    @Override  // ldr
    public final Object c(Object object0, OutputStream outputStream0) {
        ((bgov)object0).writeToStream(outputStream0);
        return ibom.a;
    }
}
