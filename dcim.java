...
import com.google.android.gms.nearby.sharing.NearbySharingModuleBackupAgentService;

public abstract class dcim extends BoundService implements eixj, ejbp {
    ...
    public final void onCreate() {
        if(!this.c) {
            this.c = true;
            ((dcic)this.h()).c(((NearbySharingModuleBackupAgentService)this));
        }
    }
}
