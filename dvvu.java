...
public final class dvvu implements evqc {
    public final ValuableDetailUnifiedFragment a;
    public final Valuable b;
    public final boolean c;
    public final fshh d;

    public dvvu(ValuableDetailUnifiedFragment valuableDetailUnifiedFragment0, Valuable valuable0, boolean z, fshh fshh0) {
    ...
    public final void gv(Exception exception0) {
        ((ggtj)((ggtj)ValuableDetailUnifiedFragment.a.i()).s(exception0)).B("Failed to update wallet surfacing state for valuable ID: %s", this.b.b);
